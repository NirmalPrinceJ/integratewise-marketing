...
function ArchitectureDiagram() {
  return (
    <div className="bg-[#0f1a15] rounded-2xl p-6 md:p-8 text-white">
...
export function Pillars() {
  const pillars = [
    {
      icon: <Layout className="w-10 h-10 text-[#059669]" />,
      ...
      color: "border-[#059669]/20 hover:border-[#059669]/40"
    },
    {
      icon: <Users className="w-10 h-10 text-[#059669]" />,
    ...
    },
    {
      ...
      color: "border-[#10b981]/20 hover:border-[#10b981]/40"
    }
  ];
    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#0f1a15] mb-6">An AI-Native Integration Intelligence OS</h2>
            ...
            {pillars.map((pillar, i) => (
              <div key={i} className={`p-6 md:p-8 rounded-2xl bg-white border ${pillar.color} shadow-sm hover:shadow-xl transition-all group text-left`}>
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0f1a15] mb-2">{pillar.title}</h3>
