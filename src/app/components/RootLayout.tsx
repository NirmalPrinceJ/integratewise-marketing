...
const NAV_STRUCTURE: NavEntry[] = [
  ...
  {
    type: 'item',
    item: { to: '/website', icon: Globe, label: 'Marketing Website (New)', end: true },
  },
  {
    type: 'item',
  ...
  },
  {
    ...
    group: {
      ...
      children: [
        ...
        { to: '/product-landing-pages', icon: MonitorSmartphone, label: 'Product Landing Pages', color: '#F59E0B' },
        { to: '/sales', icon: HandCoins, label: 'Sales', color: '#D9637F' },
        { to: '/ready-made-content', icon: PenLine, label: 'Ready-Made Content', color: '#8B5CF6' },
      ],
    },
  },
  {
