      ...
      <section className="relative overflow-hidden border-b border-border bg-gradient-to-b from-background to-muted/20">
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-pretty text-xl font-medium leading-relaxed sm:text-2xl">
              One workspace. All your tools. AI-powered.
            </p>
            <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
              IntegrateWise connects everything through a shared structure, routes it securely, and uses AI agents to
              turn your work into action—without migrations or rebuilding your world.
            </p>
            ...
            <p className="mt-8 text-sm font-medium text-muted-foreground">Normalize Once. Render Anywhere.</p>
            <p className="mt-2 text-sm text-muted-foreground">
              Full integration or safe, read-only mode. BYOM supported.
            </p>
          </div>
        </div>
      </section>
