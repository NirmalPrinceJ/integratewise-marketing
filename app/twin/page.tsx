...
export default function TwinPage() {
  ...
  const twinLoop = [
    ...
    { num: 5, icon: "fa-rocket", color: "orange", title: "Act / Write", description: "On approval, Twin acts in your tools (update Salesforce stage, draft a follow-up email, schedule a call) and writes the decision back to Digital Memory—compounding what it knows." }
  ]
        ...
        <section id="cognitive-hero" className="relative pt-32 pb-24 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto mb-12 leading-relaxed">
              Your Twin is the reasoning layer that lives between the Spine (your Digital Memory) and the Workspace (where you decide). It observes, infers patterns, cites evidence, and suggests actions—but never acts without your approval.
            </p>
