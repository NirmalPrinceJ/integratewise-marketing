      ...
      &#123;/* Header */&#125;
          <section id="resources-hero" className="relative pt-40 pb-24 px-6 overflow-hidden min-h-[650px] flex items-center">
              ...
              <div className="max-w-7xl mx-auto relative z-10 text-center">
                  ...
                  <h1 className="text-6xl lg:text-7xl font-bold mb-6 leading-tight">Articles</h1>
                  
                  <p className="text-xl text-text-secondary max-w-3xl mx-auto mb-12 leading-relaxed">Deep-dives, technical breakdowns, and insights from the team.</p>
