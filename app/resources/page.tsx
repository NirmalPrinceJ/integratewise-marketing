  ...
  return (
    <>
      &#123;/* Header */&#125;
          <section id="resources-hero" className="relative pt-40 pb-24 px-6 overflow-hidden min-h-[650px] flex items-center">
              ...
              <div className="max-w-7xl mx-auto relative z-10 text-center">
                  ...
                  <p className="text-xl text-text-secondary max-w-3xl mx-auto mb-12 leading-relaxed">
                      Explore guides, case studies, architecture deep-dives, and practical insights on building memory-first systems that compound over time.
                  </p>
          ...
          <section id="filter-section" className="py-8 px-6 bg-bg-secondary/50 border-b border-white/5 sticky top-[72px] z-40 backdrop-blur-md">
              <div className="max-w-7xl mx-auto">
                  <div className="flex items-center justify-between gap-6 flex-wrap">
                      <div className="flex items-center gap-3 flex-wrap">
                          <button className="filter-btn active px-5 py-2 rounded-lg text-sm font-medium border border-white/10 transition-all hover:border-gold/30" data-filter="all">
                              All Resources
                          </button>
                          <button className="filter-btn px-5 py-2 rounded-lg text-sm font-medium border border-white/10 transition-all hover:border-gold/30" data-filter="platform">
                              Spine
                          </button>
                          <button className="filter-btn px-5 py-2 rounded-lg text-sm font-medium border border-white/10 transition-all hover:border-gold/30" data-filter="product">
                              The Workbench
                          </button>
                          <button className="filter-btn px-5 py-2 rounded-lg text-sm font-medium border border-white/10 transition-all hover:border-gold/30" data-filter="cognitive">
                              The Twin
                          </button>
                          <button className="filter-btn px-5 py-2 rounded-lg text-sm font-medium border border-white/10 transition-all hover:border-gold/30" data-filter="solutions">
                              Solutions
                          </button>
                          <button className="filter-btn px-5 py-2 rounded-lg text-sm font-medium border border-white/10 transition-all hover:border-gold/30" data-filter="trust">
                              Trust & Control
                          </button>
                      </div>
          ...
          <section id="featured-resources" className="py-16 px-6">
              <div className="max-w-7xl mx-auto">
                  <div className="flex items-center justify-between mb-10">
                      <div>
                          <h2 className="text-4xl font-bold mb-2">Featured Content</h2>
                          <p className="text-text-secondary">Essential reads for understanding IntegrateWise</p>
                      </div>
                  </div>
      
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      <div className="resource-card glass-card rounded-2xl overflow-hidden cursor-pointer group" data-type="guide">
                          <div className="h-64 bg-gradient-to-br from-gold/20 to-bg-elevated relative overflow-hidden">
                              <div className="absolute inset-0 flex items-center justify-center">
                                  <i className="fa-solid fa-layer-group text-gold/40 text-8xl"></i>
                              </div>
                          ...
                          <h3 className="text-2xl font-bold mb-3 group-hover:text-gold transition-colors">Understanding the Spine: The Foundation of Entity Memory</h3>
                              <p className="text-text-secondary leading-relaxed mb-6">
                                  A comprehensive guide to how IntegrateWise builds a persistent, governed memory layer that unifies scattered business data into a single source of truth.
                              </p>
                              <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                      <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-2.jpg" className="w-8 h-8 rounded-full" alt="Author" />
                                      <span className="text-sm text-text-dim">Engineering Team</span>
                                  </div>
                                  <i className="fa-solid fa-arrow-right text-gold group-hover:translate-x-1 transition-transform"></i>
                              </div>
                          </div>
                      </div>
      
                      <div className="resource-card glass-card rounded-2xl overflow-hidden cursor-pointer group" data-type="article">
                          <div className="h-64 bg-gradient-to-br from-purple-500/20 to-bg-elevated relative overflow-hidden">
                              <div className="absolute inset-0 flex items-center justify-center">
                                  <i className="fa-solid fa-brain text-purple-400/40 text-8xl"></i>
                              </div>
                              <div className="absolute top-4 left-4">
                          ...
                          <div className="p-8">
                              ...
                              <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Article</span>
                          <h3 className="text-2xl font-bold mb-3 group-hover:text-gold transition-colors">The Twin: Reasoning With Control</h3>
                              <p className="text-text-secondary leading-relaxed mb-6">
                                  Learn how IntegrateWise separates memory from reasoning, ensuring your Twin serves you without polluting your source of truth.
                              </p>
                              <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                      <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-5.jpg" className="w-8 h-8 rounded-full" alt="Author" />
                                      <span className="text-sm text-text-dim">Product Team</span>
                                  </div>
                                  <i className="fa-solid fa-arrow-right text-gold group-hover:translate-x-1 transition-transform"></i>
                              </div>
                          </div>
          ...
          <section id="resource-grid" className="py-16 px-6 bg-bg-secondary/30">
              <div className="max-w-7xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                      ...
                      <div className="resource-card glass-card rounded-2xl p-8 cursor-pointer" data-category="solutions" data-type="case-study">
                          <div className="flex items-start justify-between mb-4">
                              <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center">
                                  <i className="fa-solid fa-handshake text-purple-400 text-xl"></i>
                              </div>
                              <span className="bg-purple-500/20 border border-purple-500/30 text-purple-400 px-3 py-1 rounded-full text-xs font-semibold">Solutions</span>
                          </div>
                          <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Case Study</span>
                          <h3 className="text-xl font-bold mb-3">Case Study: Saving an $8M Account</h3>
                          <p className="text-text-secondary text-sm leading-relaxed mb-4">
                              How a Customer Success team used IntegrateWise to identify renewal risks weeks before they became critical.
                          </p>
                          <div className="flex items-center gap-3 text-xs text-text-dim">
                      ...
                      <div className="resource-card glass-card rounded-2xl p-8 cursor-pointer" data-category="platform" data-type="article">
                          <div className="flex items-start justify-between mb-4">
                              <div className="w-12 h-12 bg-gold/10 rounded-xl flex items-center justify-center">
                                  <i className="fa-solid fa-diagram-project text-gold text-xl"></i>
                              </div>
                              <span className="bg-gold/20 border border-gold/30 text-gold px-3 py-1 rounded-full text-xs font-semibold">Spine</span>
                          </div>
                          <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Article</span>
                          <h3 className="text-xl font-bold mb-3">Vector Stores and Entity Graphs</h3>
                          <p className="text-text-secondary text-sm leading-relaxed mb-4">
                              Technical deep-dive into how we structure semantic memory for instant retrieval and relationship mapping.
                          </p>
                          <div className="flex items-center gap-3 text-xs text-text-dim">
                      ...
                      <div className="resource-card glass-card rounded-2xl p-8 cursor-pointer" data-category="cognitive" data-type="article">
                          <div className="flex items-start justify-between mb-4">
                              <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center">
                          ...
                          <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Article</span>
                          <h3 className="text-xl font-bold mb-3">Model-Agnostic Reasoning Layer</h3>
                          <p className="text-text-secondary text-sm leading-relaxed mb-4">
                              Why separating memory from models gives you stability as AI evolves. Frontier Reasoning, frontier model providers—your choice.
                          </p>
                          <div className="flex items-center gap-3 text-xs text-text-dim">
                              <span>12 min read</span>
                              <span>•</span>
                      ...
                      <div className="resource-card glass-card rounded-2xl p-8 cursor-pointer" data-category="solutions" data-type="case-study">
                          ...
                          <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Case Study</span>
                          <h3 className="text-xl font-bold mb-3">Business Ops: Real-Time Insights</h3>
                          <p className="text-text-secondary text-sm leading-relaxed mb-4">
                              How a 50-person startup reduced reporting overhead by 80% while gaining better visibility into burn and runway.
                          </p>
                          <div className="flex items-center gap-3 text-xs text-text-dim">
                      ...
                      <div className="resource-card glass-card rounded-2xl p-8 cursor-pointer" data-category="platform" data-type="article">
                          <div className="flex items-start justify-between mb-4">
                              <div className="w-12 h-12 bg-gold/10 rounded-xl flex items-center justify-center">
                                  <i className="fa-solid fa-arrows-spin text-gold text-xl"></i>
                              </div>
                              <span className="bg-gold/20 border border-gold/30 text-gold px-3 py-1 rounded-full text-xs font-semibold">Spine</span>
                          </div>
                          <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Article</span>
                          <h3 className="text-xl font-bold mb-3">The Continuous Loop Explained</h3>
                          <p className="text-text-secondary text-sm leading-relaxed mb-4">
                              How IntegrateWise continuously ingests, learns, reasons, and acts—creating compounding knowledge over time.
                          </p>
                          <div className="flex items-center gap-3 text-xs text-text-dim">
                      ...
                      <div className="resource-card glass-card rounded-2xl p-8 cursor-pointer" data-category="solutions" data-type="case-study">
                          <div className="flex items-start justify-between mb-4">
                              <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center">
                                  <i className="fa-solid fa-user-astronaut text-purple-400 text-xl"></i>
                              </div>
                              <span className="bg-purple-500/20 border border-purple-500/30 text-purple-400 px-3 py-1 rounded-full text-xs font-semibold">Solutions</span>
                          </div>
                          <span data-type-pill className="inline-block px-2.5 py-1 rounded-md text-[11px] font-semibold uppercase tracking-wider bg-gold/10 text-gold border border-gold/20 mb-3">Case Study</span>
                          <h3 className="text-xl font-bold mb-3">Personal Ops: Your Second Brain</h3>
                          <p className="text-text-secondary text-sm leading-relaxed mb-4">
                              How individual knowledge workers use IntegrateWise to index emails, notes, and documents into a private OS.
                          </p>
                          <div className="flex items-center gap-3 text-xs text-text-dim">
                              <span>10 min read</span>
                              <span>•</span>
