...
- Name: site.spec.ts >> IntegrateWise Marketing Site >> How It Works Page >> has comparison table
- Location: tests/site.spec.ts:116:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/how-it-works
Call log:
  - navigating to "http://localhost:8788/how-it-works", waiting until "load"
